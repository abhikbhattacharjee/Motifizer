...
for dirpath, dirnames, files in os.walk('Output_fimo/Prediction_source_fimo'): #Output_fimo folder
...
#print("abc" + test_group_final)

test_group_final=test_group_final.fillna(0)
#print("abc" + test_group_final)
test_group_final.to_excel("Excel/Prediction.xlsx",sheet_name="Prediction")
